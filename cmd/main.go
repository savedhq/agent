...
func main() {
	...
	w.RegisterWorkflowWithOptions(workflows.IMAPBackupWorkflow, workflow.RegisterOptions{Name: names.WorkflowNameIMAP})
	...
	w.RegisterActivityWithOptions(acts.IMAPConnectActivity, activity.RegisterOptions{Name: names.ActivityNameIMAPConnect})
	w.RegisterActivityWithOptions(acts.IMAPDownloadActivity, activity.RegisterOptions{Name: names.ActivityNameIMAPDownload})
	w.RegisterActivityWithOptions(acts.IMAPUploadActivity, activity.RegisterOptions{Name: names.ActivityNameIMAPUpload})
	w.RegisterActivityWithOptions(acts.IMAPDisconnectActivity, activity.RegisterOptions{Name: names.ActivityNameIMAPDisconnect})
